...
- `03_data/processed/` 中现有 `.npz` 是信号数组；本次检查没有发现已经生成的 `96×96` CWT 图片。
...
![教学输入与教学 CWT-like 矩阵](../04_experiments/day4/01_input_example.png)
...
![教学 kernel](../04_experiments/day4/02_kernel_demo.png)
...
![不同 kernel 的 feature map](../04_experiments/day4/03_feature_map_demo.png)
...
![ReLU 与 pooling](../04_experiments/day4/04_pooling_demo.png)
...
脚本位置：`02_code/scripts/day4_cnn_visualization.py`

运行：

```powershell
D:/Anaconda3/python.exe 02_code/scripts/day4_cnn_visualization.py
```
