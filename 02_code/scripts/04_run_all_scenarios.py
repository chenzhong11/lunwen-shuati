...
def main():
    ...
    parser.add_argument('--config', type=str, default='02_code/config/default.yaml', help='配置文件')
    parser.add_argument('--seed', type=int, default=42, help='随机种子')
    parser.add_argument('--data-path', type=str, default='03_data/raw', help='数据目录')
    parser.add_argument('--output', type=str, default='05_results', help='输出目录')
