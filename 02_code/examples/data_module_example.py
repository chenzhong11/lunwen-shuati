...
def example_dataset_creation():
    ...
    # 保存数据集
    save_path = './03_data/processed/example_dataset.npz'
...
def example_scenario_creation():
    ...
    # 保存数据
    save_path = './03_data/processed/processed_data.npz'
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
def example_leakage_check():
    ...
    # 生成报告
    report = checker.generate_report('./01_notes/leakage_check.txt')
